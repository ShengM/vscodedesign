...
import 'css!./media/scrollbars';
import { isEdgeOrIE } from 'base/browser/browser';
import * as dom from 'base/browser/dom';
import { FastDomNode, createFastDomNode } from 'base/browser/fastDomNode';
import { IMouseEvent, StandardWheelEvent, IMouseWheelEvent } from 'base/browser/mouseEvent';
import { ScrollbarHost } from 'base/browser/ui/scrollbar/abstractScrollbar';
import { HorizontalScrollbar } from 'base/browser/ui/scrollbar/horizontalScrollbar';
import { ScrollableElementChangeOptions, ScrollableElementCreationOptions, ScrollableElementResolvedOptions } from 'base/browser/ui/scrollbar/scrollableElementOptions';
...
import { INewScrollDimensions, INewScrollPosition, IScrollDimensions, IScrollPosition, ScrollEvent, Scrollable, ScrollbarVisibility } from 'base/common/scrollable';
